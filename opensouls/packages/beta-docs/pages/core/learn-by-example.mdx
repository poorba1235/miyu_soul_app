...
import { externalDialog } from "./lib/cogntiveSteps.ts";
...
<Callout type="info" emoji="ℹ️">
  These cognitiveSteps (and more) are available in our [Resources Library](../blueprints/resources-library)
</Callout>

Below are the cognitive steps used in the examples above.

```ts filename="./lib/cognitiveSteps.ts"
import { z, WorkingMemory, createCognitiveStep, indentNicely, stripEntityAndVerb, stripEntityAndVerbFromStream, ChatMessageRoleEnum } from "@opensouls/engine"
